...
class TxCodecSpec extends Spec {
  ...
  "Tx encoder and decoder" should "be the inversion of each other" in {
    ...
    val nonWitnessHugeHex = Source.fromURI(getClass.getResource(s"/transaction/d519b6cb8d696585f2107b6d3cc464fad995f91c1619b66bc5254de7e6c43398.hex").toURI).mkString
